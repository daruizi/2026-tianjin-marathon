...
const WEEK_REVIEWS = [
  {
    ...
    days: [  // 计划 vs 实际
      ...
      { d: '周四', plan: 17, act: 16.14, pace: '5:21.9', hr: 150, temp: 24, ok: false, note: '因雨顺延的主课(改期合理), 但内容从计划的 5×2km @3:58 (T) 换成 6×1000m 递减 + 10×400m (I/R)' },
    ...
    gaps: [
      ...
      '③ 主课「内容」被替换: 5×2km @3:58 (T) → 6×1000m 递减 + 10×400m (I/R), 第 3 次同型替换; I/R 早已达标, 被换掉的是给 MP 供能的 T 量。' +
      '注: 因周三下雨顺延到周四「不」算执行偏差, 那是正确处理 —— 当天仍照跑 21.3km E, 且离周日还有 3 天。',
      '④ 力量训练仍无记录 (计划周一 25min + 周五 15min)',
    ],
    nextFocus: 'W15 唯一新课题 = 把 MP 段挪到长跑前段 (第 9km 起跑 2×7km), 而不是靠渐进「跑进去」。' +
               '另: 若湿滑路面也是选择短间歇的原因, W15 把 T 课排在干燥那天, 不要就着场地换课型。',
