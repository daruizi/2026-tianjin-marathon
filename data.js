...
const MILESTONES = [
  ...
  { date: '2026-09-13', label: '✓ go/no-go: GO (W16)',  desc: '考 16km 连续 MP, 实跑 36.67km 中 32.0km 连续 @ 4:19.7 / HR 158.7 (23℃) · 0 停表 · 后 4km 快 6.1 s/km · 脱钩 −2.1% → 目标锁定 2:54:30' },
...
const PHASES = {
  ...
  race:  { name: '比赛期',    range: 'W15-W19', color: '#ffd1d1', desc: 'MP 专项重建: 14 → 16连续 → 8 → 20连续 → 14 km @ 4:08 · W15 已完成: 不间断 MP 块 9.41km @4:21.8/HR160 (质量四项判据全过, 差里程), 但长跑停表回升到 16.1min · W16 已完成: ★ go/no-go GO —— 32.0km 连续 @4:19.7/HR158.7, 0 停表, 目标锁定 2:54:30' },
