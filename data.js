...
const PACES = {
  ...
  recovery: { range: '5:00-5:20', hr: '≤140', desc: '周四专用, 慢即正确' },
  M:        { range: '4:08',      hr: '~160', desc: '目标比赛配速' },
  T:        { range: '3:55-4:00', hr: '168-175', desc: 'W1-W4 起步 4:00, W5+ 压到 3:55' },
  I:        { range: '3:35-3:40', hr: '~max-5', desc: 'VO2max, 3-5 min reps' },
  R:        { range: '3:25-3:30', hr: '—', desc: '200-400m, 神经肌肉' },
};
