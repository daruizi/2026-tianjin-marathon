...
const WEEK_REVIEWS = [
  {
    ...
    days: [  // 计划 vs 实际
      ...
      { d: '周三', plan: 17, act: 21.33, pace: '5:19.4', hr: 129, temp: 24, ok: false, note: '计划 5×2km @3:58 未执行, 改纯 E' },
      { d: '周四', plan: 17, act: 16.14, pace: '5:21.9', hr: 150, temp: 24, ok: false, note: '主课挪到周四, 且换成 6×1000m 递减 + 10×400m (I/R)' },
    ...
    gaps: [
      ...
      '③ 周三阈值课被替换成周四的 I/R 间歇 —— 第 3 次同型替换; I/R 早已达标, 被换掉的是给 MP 供能的 T 量',
